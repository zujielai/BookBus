...
<body translate="no" >
  <header>
	<nav class="navbar navbar-expand-lg">
		<div class="container">
			<a class="navbar-brand text-white" href="http://localhost:8000/"><i class="fa fa-bus fa-fw mr-1"></i>BookBus</a>
			...
			<div class="collapse navbar-collapse" id="nvbCollapse">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item pl-1">
						<a class="nav-link" href="http://localhost:8000/"><i class="fa fa-home fa-fw mr-1"></i>Home</a>
					</li>
					<li class="nav-item active pl-1">
						<a class="nav-link" href="http://localhost:8000/busTicket"><i class="fa fa-ticket fa-fw mr-1"></i>Bus Ticket</a>
					</li>
					<li class="nav-item pl-1">
						<a class="nav-link" href="http://localhost:8000/contact"><i class="fa fa-phone fa-fw mr-1"></i>Contact Us</a>
					</li>
          <li class="nav-item pl-1">
						<a class="nav-link" href="http://localhost:8000/myTrip"><i class="fa fa-bus fa-fw mr-1"></i>My Trip</a>
					</li>
					<li class="nav-item pl-1">
						<a class="nav-link" href="http://localhost:8000/userProfile"><i class="fa fa-user fa-fw mr-1"></i>User Profile</a>
					</li>
          
                    <li class="nav-item pl-1">
						<a class="nav-link" href="http://localhost:8000/login"><i class="fa fa-sign-in fa-fw mr-1"></i>Login/Register</a>
					</li>
				</ul>
			</div>
		</div>
